...
import { LinkData, Links } from '../components/home/Links';
...
const credentialColumnData: CredentialColumnData[] = [
    ...
    },
    {
        ...
        items: [
            {
                link: 'https://learn.microsoft.com/api/credentials/share/en-us/miberr/391A8C6E12EB19AE?sharingId=E13526A50BF73FFB',
                label: 'Azure AI Engineer Associate',
                code: 'AI-102',
            },
            {
            ...
            <main>
                <div className="container padding-vert">
                    ...
                    <Credentials
                        ...
                        separateImages={credentialSeparateImages}
                    />
